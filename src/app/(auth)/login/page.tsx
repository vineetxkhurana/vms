...
function LoginPageInner() {
  ...
  const sendOTP = async () => {
    ...
    toast.success(
      `OTP sent to ${isPhone ? 'your phone' : 'your email'}. Check server console in dev mode.`,
    )
    setStep('otp')
  }
              ...
              <div key={s} className="flex items-center gap-2">
                  ...
                  style={{
                    background:
                      step === s
                        ...
                        : i < (['identifier', 'otp', 'password'] as Step[]).indexOf(step)
                          ? 'rgba(0,229,160,0.2)'
                ...
                {i === 0 && (
                  <div
                    ...
                    style={{ background: 'rgba(0,194,255,0.12)', width: 40 }}
                  />
                )}
              </div>
            ))}
