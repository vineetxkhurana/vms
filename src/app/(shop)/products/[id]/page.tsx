    ...
    >
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-start">
          {/* ── Image card ───────────────────────────────── */}
          <div
            className="rounded-2xl sticky top-24 overflow-hidden"
            style={{
              background: '#f0f4f8',
          ...
          <div className="space-y-6">
            {product.brand === 'VMS' && (
              <span
                className="inline-block px-4 py-1.5 rounded-full text-sm font-bold text-secondary"
                style={{
            ...
            <div>
              <h1
                className="font-display font-black text-on-surface"
            ...
            <div className="flex items-end gap-3">
              <span className="font-display font-black text-primary" style={{ fontSize: 48 }}>
                ₹{priceRs}
              </span>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
              {allVariants.map((v: ProductVariant) => (
                <Link key={v.id} href={`/products/${v.id}`} style={{ textDecoration: 'none' }}>
                  <div
                    className="glass rounded-2xl p-4 flex flex-col gap-3 hover:border-primary/40 transition-all cursor-pointer"
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-on-surface-muted line-clamp-2 leading-tight">
                        {v.name}
                      </p>
                    </div>
